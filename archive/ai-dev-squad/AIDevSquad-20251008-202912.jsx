...
export default function AIDevSquad() {
  ...
  const [highlightedBot, setHighlightedBot] = useState(-1);

  // Demo sequence data
  const demoSequence = [
    { bot: 0, message: "Builder Bot starts analyzing your requirements..." },
    { bot: 1, message: "Deployment Bot prepares the infrastructure..." },
    { bot: 2, message: "Data Police ensures security compliance..." },
    { bot: 3, message: "Designer Bot creates the user interface..." },
    { bot: 4, message: "Project Manager coordinates the workflow..." },
    { bot: 5, message: "Logic Weaver connects all the components..." }
  ];
  ...
  const startDemo = () => {
    ...
    demoSequence.forEach((step, index) => {
      setTimeout(() => {
        setHighlightedBot(step.bot);
        // You could add a notification or message display here
        ...
        <Center>
          <Stack gap="lg" ta="center" maw={800}>
            ...
            <Group justify="center" gap="md">
              ...
              >
                {isDemoRunning ? 'Demo Running...' : 'Watch Demo'}
              </Button>
            </Group>
          ...
          <SimpleGrid cols={{ base: 2, sm: 3, lg: 6 }} spacing="lg">
            {[
              ...
              <Card 
                ...
                ta="center"
                style={{
                  transform: highlightedBot === index ? 'scale(1.05)' : 'scale(1)',
                  transition: 'all 0.3s ease',
                  boxShadow: highlightedBot === index 
                    ? '0 0 20px rgba(26, 126, 230, 0.5), 0 0 40px rgba(26, 126, 230, 0.3)' 
                    : '0 1px 3px rgba(0, 0, 0, 0.12)',
                  border: highlightedBot === index 
                    ? '2px solid #1a7ee6' 
                    : '1px solid rgba(255, 255, 255, 0.1)',
                  backgroundColor: highlightedBot === index 
                    ? 'rgba(26, 126, 230, 0.1)' 
              ...
              >
                <Stack gap="sm">
                  <Image
                    ...
                    fit="contain"
                    style={{ 
                      filter: highlightedBot === index 
                        ? 'drop-shadow(0 4px 8px rgba(26, 126, 230, 0.5)) brightness(1.1)' 
